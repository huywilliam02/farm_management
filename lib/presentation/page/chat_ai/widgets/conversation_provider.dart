...
import 'package:itfsd/data/model/chat_ai/chat_ai_models.dart';
...
class ConversationProvider extends ChangeNotifier {
  ...
  ConversationProvider() {
    _conversations.add(Conversation(messages: [], title: 'Trợ lý'));
  }
  ...
  void addEmptyConversation(String title) {
    if (title == '') {
      title = 'Trợ lý ${_conversations.length}';
    }
  ...
  void renameConversation(String title) {
    if (title == "") {
      ...
      title = 'Trợ lý $_currentConversationIndex';
    }
...
final Sender systemSender = Sender(
    name: 'System', avatarAssetPath: 'lib/app/resources/ai/avatars/bot.jpg');
final Sender userSender = Sender(
    name: 'User', avatarAssetPath: 'lib/app/resources/ai/avatars/person.png');
